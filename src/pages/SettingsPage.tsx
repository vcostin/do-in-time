...
export function SettingsPage() {
  ...
  return (
    <div>
      <PageHeader title="Settings" backTo="/" backLabel="Back to list" />

      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 max-w-md p-6">
        {loading ? (
